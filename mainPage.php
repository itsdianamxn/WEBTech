...
<body class="mainPage">
    ...
    <nav class="navbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="children.html" target="mainFrame" class="nav-link">
            ...
            <li class="nav-item">
                <a href="media.html" target="mainFrame" class="nav-link">
        ...
        <main>
            <iframe src="children.html" name="mainFrame" style="width: 100%; height: 100%; border: none;"></iframe>
        </main>
</body>
