...
<body class="mainPage">
    ...
    <nav class="navbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="groups.html" target="mainFrame" class="nav-link">
                    <span class="link-text">Groups</span>
                    <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="people-group" role="img"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 642 522"
                        class="svg-inline--fa-solid fa-people-group fa-w-14 fa-5x">
                        <path fill="currentColor"
